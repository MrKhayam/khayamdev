    ...
    <div className="min-h-screen bg-gray-900 font-[Poppins]">
      ...
      <motion.div
        ...
        style={{
          ...
          width: "600px", // Your medium size
          height: "600px", // Your medium size
          borderRadius: "50%", // Base shape, softened by blur
          filter: "blur(40px)", // Heavy blur for feathered, non-circular look
          boxShadow: "0 0 80px rgba(17, 31, 68, 0.6)", // Soft outer glow
          transform: `translate(${mousePosition.x - 300}px, ${
            mousePosition.y - 300
          }px)`, // Instant centering
        }}
      />
        ...
        <div className="left md:w-[40%] w-full md:h-full h-auto text-white md:py-20 py-10">
          <div className="w-full h-full md:fixed">
            ...
            <div className="md:flex  hidden flex-col text-[#7D90B7] gap-2 mt-20">
              <h1 className="cursor-pointer hover:text-white transition-all duration-300">
                About
              </h1>
              <h1 className="cursor-pointer hover:text-white transition-all duration-300">
                Experience
            ...
            <div className="icons flex gap-3 mt-5 md:mt-20 items-center">
              <FaGithub color="#7D90B7" cursor="pointer" size={25} />
              <FaLinkedin color="#7D90B7" cursor="pointer" size={25} />
              <FaInstagram color="#7D90B7" cursor="pointer" size={25} />
            </div>
            <p className="text-[#7D90B7] text-sm mt-4">+923175080524</p>
            <p className="text-[#7D90B7] text-sm">ijazkhayam@gmail.com</p>
          </div>
        </div>
        <div className="left md:w-[60%] relative z-10 w-full md:h-full h-auto text-[#7D90B7] md:mt-20 mt-10 md:px-10">
          ...
          <p>
            ...
            components that power <span className="text-white">
              Klaviyo’s
            </span>{" "}
            frontend, ensuring our platform meets web accessibility standards
            and best practices to deliver an inclusive user experience. <br />{" "}
            <br /> In the past, I've had the opportunity to develop software
            ...
            building a web app with the Spotify API. <br /> <br /> In my spare
            time, I’m usually climbing, reading, hanging out with my wife and
            two cats, or running around Hyrule searching for Korok seeds{" "}
            <span className="text-white">K o r o k s e e d s .</span> .
          </p>
          ...
          <div className="flex md:mt-32 md:flex-row flex-col w-full min-h-50 gap-3 transition-all duration-300 cursor-pointer hover:bg-[#b6b6b60c] border-t md:p-5 border-transparent hover:border-[#7c7c7c3a] rounded-md backdrop-blur-medium">
            ...
            <div className="expRight md:w-[80%] h-full">
              <h1 className="text-white font-medium">
                Senior Front End Engineer, Accessiblity - Creatobype
              </h1>
          ...
          <div className="Proj flex md:mt-4 mt-8 mb-3 flex-col w-full min-h-50 gap-3 transition-all duration-300 items-center cursor-pointer hover:bg-[#b6b6b60c] border-t md:p-5 border-transparent hover:border-[#7c7c7c3a] rounded-md backdrop-blur-medium">
            ...
            <div className="expRight md:w-full h-full">
              ...
              <div className="w-full flex items-center justify-end">
                <button className="mt-7 self-end flex gap-1 rounded-full py-2 hover:bg-[#54d4d423] transition-all duration-300 px-6  hover:text-[#53e4e4]  items-cente  cursor-pointer">
